...
using Test.Test.Migrations.Seed.Host;
using Test.Test.Migrations.Seed.Tenants;
using Test.Test.MultiTenancy;
using Test.Test.Tests.TestDatas;
...
namespace Test.Test.Tests
{
    ...
    /// Provides methods to easily work with <see cref="TestDbContext"/>.
    /// </summary>
    public abstract class AppTestBase : AbpIntegratedTestBase<TestTestModule>
    {
