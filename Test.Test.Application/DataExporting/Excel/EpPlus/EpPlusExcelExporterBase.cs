...
using Test.Test.Dto;
using Test.Test.Net.MimeTypes;
using OfficeOpenXml;

namespace Test.Test.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : TestServiceBase, ITransientDependency
    {
