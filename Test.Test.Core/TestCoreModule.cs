...
using Test.Test.Authorization.Ldap;
...
using Test.Test.Features;
using Test.Test.Emailing;
using Test.Test.Friendships;
using Test.Test.Friendships.Cache;
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
             {
                Configuration.IocManager.IocContainer.Register(
                    ...
                    .ImplementedBy<TestSmtpEmailSenderConfiguration>()
                    .LifestyleTransient()
                );
            });
